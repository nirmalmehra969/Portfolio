...
export default function ContactSection() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://formsubmit.co/ajax/nirmalmehra969@gmail.com', {
                method: 'POST',
                headers: {
            ...
            <div className="container">
                ...
                <div className="contact-grid">
                        ...
                        <div className="terminal-window contact-terminal">
                            ...
                            <div className="terminal-body">
                                ...
                                <div className="contact-links">
                                    <a href="mailto:nirmalmehra969@gmail.com" className="contact-link">
                                        <FiMail />
                                        <span>nirmalmehra969@gmail.com</span>
                                    </a>
                                    <a href="tel:+917856890680" className="contact-link">
                                        <FiPhone />
                                        <span>+91 7856890680</span>
                                    </a>
                                    <a href="https://github.com/nirmalmehra969" target="_blank" rel="noopener noreferrer" className="contact-link">
                                        <FiGithub />
                                        <span>github.com/nirmalmehra969</span>
                                    </a>
                                    <a href="https://linkedin.com/in/nirmal-kumar849" target="_blank" rel="noopener noreferrer" className="contact-link">
                                        <FiLinkedin />
                                        <span>linkedin.com/in/nirmal-kumar849</span>
                                    </a>
                                </div>
                                <br />
                    ...
                    >
                        ...
                        {status === 'sent' && (
                            <p className="form-status success">✓ Your message has been delivered to Nirmal!</p>
                        )}
                        {status === 'error' && (
